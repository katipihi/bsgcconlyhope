...
public class FollowTag extends LinearOpMode
{
    ...
    final double MAX_AUTO_TURN  = 0.08;   //  Clip the turn speed to this max value (adjust for your robot)
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (targetFound) {
                telemetry.addData(">","Press a to track target press b to cancel\n");
