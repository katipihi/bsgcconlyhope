...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.8466; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -3.42; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 0.9988; // Multiplier in the X direction
